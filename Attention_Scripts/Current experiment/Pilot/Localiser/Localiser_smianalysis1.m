...
matfilename = sprintf('%s_Localiser1', ParticipantID);
save(matfilename)

%% Get eye data files
M1 = [];
M1 = Atten_readEyeData('iViewXSDK_Matlab_Data_Localiser1 Samples.txt');
...
Valid1 =(length(find(Matrix1(:,3)>=0.001&Matrix1(:,6)>=0.001&Matrix1(:,7)>=0.001))/nrtrials)*100; %percentage valid trials
