...
*
* Setup RED operation mode parameters with "REDMonitorAttachedGeometryStruct" use function 
* "iV_SetupREDMonitorAttachedGeometry".
*/ 
struct REDMonitorAttachedGeometryStruct
{
	int stimX;
...
*
* receives online eye image or scene video with "iV_GetEyeImage", "iV_GetSceneVideo", 
* "iV_SetEyeImageCallback", or "iV_SetScenevideoCallback" functions 
*/ 
struct ImageStruct
{
	int imageHeight;
...
* @return	ERR_WRONG_PARAMETER		- parameter out of range
**/ 
DLLExport int __stdcall iV_DefineAOI(AOIStruct aoiData);
...
/**
* @brief 	defines remotely the RED-m stand alone mode 
*			(see chapter 'RED Monitor Attached Mode' in the iView X SDK Manual) 
*
