...
if practice == 0;
    ...
    [Data,Text] = xlsread('TrialCounter_locprac.xlsx'); %practice trials
end
...
if practice == 0;
    ...
    matfilename = sprintf ('Localiser_prac%d%d%d%d%d.mat', datenow (1), datenow(2), datenow(3), datenow(4), datenow(5));
end
...
%% END, CLOSE AND SAY THANKS
    ...
    if smi       
        %save iViewX file
        user = formatString(64, int8('Localiser1')); %Put your own file name in quotes here
