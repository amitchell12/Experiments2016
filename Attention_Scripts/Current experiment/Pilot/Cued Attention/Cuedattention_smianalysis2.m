...
%% Get eye data files
M2 = [];
M2 = Atten_readEyeData('iViewXSDK_Matlab_Data_2CuedAttention Samples.txt');
...
Valid2 =(length(find(Matrix2(:,2)>=0.001&Matrix2(:,3)>=0.001&Matrix2(:,6)>=0.001&Matrix2(:,7)>=0.001))/nrtrials)*100; %percentage valid trials
AccurateAll2 =(length(find(Matrix2(:,3)>=0.001))/nrtrials)*100; %percentage invalid trials
