...
%% Get eye data files
M3 = [];
M3 = Atten_readEyeData('iViewXSDK_Matlab_Data_3CuedAttention Samples.txt');
...
Valid3 =(length(find(Matrix3(:,2)>=0.001&Matrix3(:,3)>=0.001&Matrix3(:,6)>=0.001&Matrix3(:,7)>=0.001))/nrtrials)*100; %percentage valid trials
AccurateAll3 =(length(find(Matrix3(:,3)>=0.001))/nrtrials)*100; %percentage invalid trials
