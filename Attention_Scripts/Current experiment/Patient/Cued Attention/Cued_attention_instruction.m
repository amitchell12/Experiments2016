...
xcuedeg=-10.3863080080343; % TO INPUT from the graph in the step 1
nrtargets=20;
trialnr = 1;
...
datenow = clock;
    matfilename = sprintf ('Cued_attention_instruc%d%d%d%d%d.mat', datenow (1), datenow(2), datenow(3), datenow(4), datenow(5)); %name of the output file
