...
Matrix3(:,7)= Othertrials;

Valid1=(length(find(Matrix3(:,3)>=0.001))/nrtrials)*100; %percentage of trials that are valid
Accurate1=(length(find(Matrix3(:,2)>=0.001))/nrtrials)*100; %percentage of trials that are accurate
