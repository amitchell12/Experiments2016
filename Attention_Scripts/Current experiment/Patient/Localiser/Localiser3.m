...
%% Start the trials
        for i=1:length(targetss)
            %% Marking trials for participant
...
%% END, CLOSE AND SAY THANKS
        ...
        text = 'The first task is finished! Thank you :)'; %message
...
Valid1=(length(find(Matrix3(:,3)>=0.001&Matrix3(:,6)<0.001&Matrix3(:,7)<0.001))/nrtrials)*100; %percentage of trials that are valid
