...
%% Start the trials
        for i=1:length(targetss)
            ...
            %% Marking trials for  participants
...
%% END, CLOSE AND SAY THANKS
        ...
        text = 'Second part done, thank you!'; %message
...
Valid1=(length(find(Matrix2(:,3)>=0.001&Matrix2(:,6)==0&Matrix2(:,7)==0))/nrtrials)*100; %percentage of trials that are valid
