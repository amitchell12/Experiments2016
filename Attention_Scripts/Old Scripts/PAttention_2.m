...
datenow = clock;
matfilename = sprintf ('Attention_2%d%d%d%d%d.mat', datenow (1), datenow(2), datenow(3), datenow(4), datenow(5)); %name of the output file
...
Accurate=(length(find(Matrix2(:,2)>=0.001))/nrtrials)*100; %percentage of trials that are accurate
